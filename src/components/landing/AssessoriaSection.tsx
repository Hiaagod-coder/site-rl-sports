...
const AssessoriaSection = () => {
  // Usando o seu link padrão de WhatsApp
    ...
    <section id="assessoria" className="py-24 relative overflow-hidden noise-overlay">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection className="text-center mb-16">
          ...
          {/* Ajustado: text-4xl no mobile e text-6xl+ no desktop */}
        ...
        <div className="max-w-5xl mx-auto relative px-2 sm:px-0">
          <AnimatedSection direction="up" delay={0.2}>
            <div className="relative group">
              {/* Brilho externo ajustado para não vazar no mobile */}
              ...
              <div className="glass-premium p-6 md:p-12 relative overflow-visible border-primary/30">
                ...
                {/* BADGE "PLANO RECOMENDADO" - Corrigido para mobile */}
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="lg:pl-12 lg:border-l border-white/10">
                    <div className="glass-card p-8 text-center mb-8 relative overflow-hidden group/price">
                      ...
                      <div className="flex items-baseline justify-center gap-2 mb-2">
                        ...
                        <span className="text-6xl md:text-7xl font-bold text-foreground">199,99</span>
                      </div>
